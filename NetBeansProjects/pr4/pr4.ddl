CREATE TABLE AUTOR (ID BIGINT NOT NULL, APELLIDOS VARCHAR(255), FECHANACIMINETO DATE, INDICEH INTEGER, NOMBRE VARCHAR(255), PRIMARY KEY (ID))
CREATE TABLE ARTICULO (ID BIGINT NOT NULL, ANIO INTEGER, NUMERO INTEGER, PAGINAINICIAL INTEGER, PAGINAFINAL INTEGER, PUBLICACION VARCHAR(255), TITULO VARCHAR(255), VOLUMEN INTEGER, PRIMARY KEY (ID))
